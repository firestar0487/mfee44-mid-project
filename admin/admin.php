...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- 產品列表 -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="../admin/products/tables.php" data-toggle="collapse" data-target="#product" aria-expanded="true" aria-controls="product">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="text-center">
                    <img  class="object-fit-cover" src="logo.png" alt="封面圖">
                </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; 墨韻雅筆2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
