            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between">
                        <h1 class="h3 mb-2 text-gray-800 ">新增文章</h1>
                    </div>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" id="title" name="title" value="" required></td>
                                        </tr>
                                        <tr>
                                            <th class="text-nowrap"><label for="description">Meta描述</label></th>
                                            <td><input type="text" class="form-control" id="description" name="description" value="" required></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <select class="custom-select" id="category_id" name="category" required>
                                                    <option selected disabled value="">請選擇分類</option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select class="custom-select" id="status" name="status" required>
                                                    <option value="待發布" selected>待發布</option>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" id="author" name="author" value="" required></td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <th class="col-2">
                                                ...
                                                <div class="cover">
                                                    ...
                                                    <div class="coverImg cursor">
                                                        <img class=" object-fit-cover" id="imagePreview" src="#" alt="Image Preview" style="display: none;">
                                                    </div>
                                                </div>
                                            </th>
                                            <td class="col-10">
                                                <!-- 文字窗 -->
                                                <div class="messageBox " id="editor1" placeholder="請輸入"></div>
                                                <!-- html標籤觀察窗口 -->
                                                <input type="hidden" id="innerText" placeholder="innerText" value="">
                                                <input type="hidden" id="innerHTML" placeholder="innerHTML" value="" name="content">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                <div class="text-center">
                                    <a href="articles-list.php" class="text-center btn btn-danger btn-md mx-auto">取消</a>
                                    <button type="submit" class="text-center btn btn-success btn-md mx-auto">新增</button>
