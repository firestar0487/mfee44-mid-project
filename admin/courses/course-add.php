    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="container">
            <form action="course-do-add.php" method="post" enctype="multipart/form-data">
              <div class="d-flex justify-content-center">
                <div class="d-flex align-items-center">
                  <a class="btn btn-primary mb-2" href="course.php"><i class="fa-solid fa-arrow-left" title="返回"></i></a>
                </div>
                <h1>
                  新增課程：
                </h1>
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-5 m-1">
                      ...
                      <input type="text" class="form-control" id="location" name="place_id" required>
                    </div>
                  </div>
                  <div class="m-1">
                  ...
                  <div class="row">
                    <div class="col-2 m-1">
                      ...
                      <input type="text" class="form-control" id="id" name="id" value="<?= $latest_id ?>" readonly>
                    </div>
                    <div class="col-3 m-1">
                  ...
                  <div class="m-1">
                    ...
                    <textarea class="form-control" id="about" rows="4" name="about" required></textarea>
                  </div>
                  <div class="row">
                    <div class="col-4 m-1">
                      <label class="form-label">價錢</label>
                      <input type="text" class="form-control" id="price" name="price" pattern="^([1-9][0-9]{0,4}|100000)$" placeholder="1~100000" required>
                    </div>
                    <div class="col-3 m-1">
                      <label class="form-label">人數</label>
                      <input type="text" class="form-control" id="num_of_student" name="num_of_student" pattern="^([1-9][0-9]|100)$" placeholder="10~100" required>
                    </div>
                    <div class="col-3 m-1">
                      <label class="form-label">時長(分鐘)</label>
                      <input type="text" class="form-control" id="minute" name="minute" pattern="^([6-9][0-9]|[1-2][0-9]{2}|3[0-5][0-9]|360)$" placeholder="60~360" required>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-5 m-1">
                  ...
                  <div class="row">
                    <div class="col-5 m-1">
                      ...
                      <input type="date" class="form-control" id="registration_start_date" name="registration_start_date" required>
                    </div>
                    <div class="col-5 m-1">
                  ...
                  <div class="row">
                    <div class="col-5 m-1">
                      ...
                      <input type="time" class="form-control" id="class_time" name="start_time" required>
                    </div>
                    <div class="col-5 m-1">
                  ...
                  <div class="m-1 my-3">
                    <input id="edit-button" class="btn btn-success " type="submit" value="確認新增">
