        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="doDeleteCoupon.php?coupon_id=<?= $row["coupon_id"] ?>" class="btn btn-danger">確認</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800 text-center">編輯優惠券</h1>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-8">
                                    ...
                                    <?php else : ?>
                                        ...
                                        <form action="doUpdateCoupon.php" method="post" id="couponForm">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="col-6">
                                                        <input type="text" class="form-control" required name="coupon_name" value="<?= $row["coupon_name"] ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="col-6">優惠券狀態</th>
                                                    <td class="col-6">
                                                        <div class="form-check mx-2">

                                                            <input class="form-check-input" type="radio" name="coupon_valid" id="coupon_valid1" value="1" <?php echo $row["coupon_valid"] == 1 ? "checked" : ""; ?>>
                                                            <label class="coupon_valid" for="coupon_valid1">
                                                                可使用
                                                            </label>
                                                        </div>
                                                        <div class="form-check mx-2">
                                                            <input class="form-check-input" type="radio" name="coupon_valid" id="coupon_valid2" value="0" <?php echo $row["coupon_valid"] == 0 ? "checked" : ""; ?>>
                                                            <label class="coupon_valid" for="coupon_valid2">
                                                                停用
                                                            </label>
                                                        </div>
                                                ...
                                                <tr>
                                                    <th class="col-6">折扣方式</th>
                                                    <td class="col-6">
                                                        <div class="form-check mx-2">
                                                            <input class="form-check-input" type="radio" name="discount_type" id="discount_type1" value="百分比" <?php echo $row["discount_type"] === '百分比' ? "checked" : ""; ?>>
                                                            <label class="discount_type" for="discount_type1">
                                                                依百分比
                                                            </label>
                                                        </div>
                                                        <div class="form-check mx-2">
                                                            <input class="form-check-input" type="radio" name="discount_type" id="discount_type2" value="金額" <?php echo $row["discount_type"] === '金額' ? "checked" : ""; ?>>
                                                            <label class="discount_type" for="discount_type2">
                                                                依金額
                                                            </label>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <th class="col-6">優惠券面額</th>
                                                    <td class="col-6">
                                                        <input type="text" class="form-control" name="discount_value" value="<?= $row["discount_value"] ?>" required>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="col-6">最低消費金額</th>
                                                    <td class="col-6">
                                                        <input type="text" class="form-control" name="price_min" value="<?= $row["price_min"] ?>" required>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="col-6">可使用次數</th>
                                                    <td class="col-6">
                                                        <input type="text" class="form-control" name="max_usage" value="<?= $row["max_usage"] ?>" required>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="col-6">開始時間</th>
                                                    <td class="col-6">
                                                        <input type="datetime-local" class="form-control" id="start_at" name="start_at" value="<?= $row["start_at"] ?>" required>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="col-6">結束時間</th>
                                                    <td class="col-6">
                                                        <input type="datetime-local" class="form-control" id="end_at" name="end_at" value="<?= $row["end_at"] ?>" required>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="col-6">優惠券使用品牌</th>
                                                    <td class="col-6">
                                                        <select class="form-select form-select-sm col-sm-12 col-form-label" aria-label=".form-select-sm example" id="usage_restrictions" name="usage_restrictions">
                                                            <option selected><?= $row["usage_restrictions"] ?></option>
                                            ...
                                            <div class="py-2 d-flex justify-content-between">
                                                <div>
                                                    <button class="btn btn-info text-white" type="submit" id="submitBtn">儲存</button>
                                                    <a class="btn btn-info text-white" href="coupon.php?coupon_id=<?= $row["coupon_id"] ?>">取消</a>
                                                </div>
                                                <div>
                                                    <button type="button" data-toggle="modal" data-target="#alertModal" class="btn btn-danger">刪除</button>
